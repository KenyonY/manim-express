...
class FourierOfTexPaths(FourierOfPiSymbol):
    CONFIG = {
        ...
        "time_per_symbol": 5,
        "slow_factor": 1 / 5,
        "parametric_function_step_size": 0.02,
    ...
    def _clip(self):
    # def construct(self):
    #     name = Text(self.animated_name, font="Ink Free")
    #     name = Text(self.animated_name, font="Gabriola")
        name = Text(self.animated_name, font="Segoe Script")
...
class FourierHeart(FourierOfTrebleClef):
    ...
    def get_shape(self):
        ...
        shape = SVGMobject("music_symbols")
        return shape
        # return shape
...
if __name__ == "__main__":
    # FourierHeart().render()
    # FourierOfPiSymbol().render()

    FourierOfTexPaths().render()
    # ExplainCircleAnimations().render()